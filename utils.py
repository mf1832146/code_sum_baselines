...
class Datagen_tree:
    def __init__(self, X, Y, batch_size, code_dic, nl_dic, path, train=True, binary=False):
        self.X = X
        self.Y = Y
...
class Datagen_binary(Datagen_tree):
    def __init__(self, X, Y, batch_size, code_dic, nl_dic, path, train=True, binary=True):
        super(Datagen_binary, self).__init__(X, Y, batch_size, code_dic,
                                             nl_dic,path, train=True, binary=True)


class Datagen_set:
    def __init__(self, X, Y, batch_size, code_dic, nl_dic, path, train=True):
        self.X = X
        self.Y = Y
        self.batch_size = batch_size
        self.code_dic = code_dic
